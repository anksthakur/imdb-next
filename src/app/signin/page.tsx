...
const page = () => {
  return (
    ...
    <div className='bg-gray-300'>
      <div className='bg-white w-4/5 mx-auto my-0 flex gap-24 px-9'>
        <div className='flex flex-col mt-8'>
      <h1 className=' font-bold text-center '>Sign in</h1>
      <Link href="/" className='border-solid border-2 border-black-500 px-2 rounded-md text-center mt-3'>Sign in with Google</Link>
      <p className='text-center mt-3'>--------- or ---------</p>
      <Link href="/login" className='border-solid border-2 border-black-500 px-2 rounded-md bg-yellow-500 text-center mt-3'>Create a New Account</Link>
